...
var xScale = d3.scale.linear().domain([100, 0]).range([50, width]),
...
// Positions the dots based on data.
    function position(dot) {
        dot 
    	    ...
    	    .attr("fill-opacity", function(d) { var l = x(d); return(x(d)/100 ); } )
            .attr("stroke-opacity", function(d) { return(x(d)/100 ); } );
    }
